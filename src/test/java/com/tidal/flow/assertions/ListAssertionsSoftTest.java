    ...
    public void listContainsTest() {
        try {
            ...
            verify("falseValueTrueTestFail", e.getMessage())
                    ...
                    .contains("com.tidal.flow.assertions.ListAssertionsSoftTest.listContainsTest");
        }
    }
    ...
    public void listContainsASuperListTest() {
        try {
            ...
            verify("The list should not contain super list", e.getMessage())
                    ...
                    .contains("com.tidal.flow.assertions.ListAssertionsSoftTest.listContainsASuperListTest");
        }
    }
    ...
    public void listContainsElementsSoftTest() {
        try {
            ...
            verify("The list should contain 'hello', 'world', 'happy', 'learning'", e.getMessage())
                    ...
                    .contains("com.tidal.flow.assertions.ListAssertionsSoftTest.listContainsElementsSoftTest");
    ...
    public void listNotContainsFalseSoftTest() {
        try {
            ...
            verify("The list should not contain 'hello', 'world'", e.getMessage())
                    ...
                    .contains("com.tidal.flow.assertions.ListAssertionsSoftTest.listNotContainsFalseSoftTest");
    ...
    public void subListTest() {
        try {
            ...
            verify("falseValueTrueTestFail", e.getMessage())
                    ...
                    .contains("Description: The list should not contain 'hello', 'world'")
                    .contains("com.tidal.flow.assertions.ListAssertionsSoftTest.subListTest");
        }
    }
    ...
    public void listSizeTest() {
        try {
            ...
            verify("falseValueTrueTestFail", e.getMessage())
                    ...
                    .contains("com.tidal.flow.assertions.ListAssertionsSoftTest.listSizeTest");
        }
    }
